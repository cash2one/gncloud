...
echo -e 'DEVICE="eth0"\nBOOTPROTO="static"\nONBOOT="yes"\nTYPE="Ethernet"\nUSERCTL="yes"\nBROADCAST=192.168.0.255\nGATEWAY=192.168.0.1\nIPADDR='${ip}'\nNETMASK=255.255.255.0' > /data/kvm/scripts/ifcfg-eth0
scp  -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null /data/kvm/scripts/ifcfg-eth0 centos@${ip}:ifcfg-eth0
...
echo -e "auto eth0\niface eth0 inet static\naddress ${ip}\nnetmask 255.255.255.0\nnetwork 192.168.0.0\nbroadcast 192.168.10.255\ngateway 192.168.0.1\ndns-nameservers 8.8.8.8" > /data/kvm/scripts/eth0.cfg
scp  -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null /data/kvm/scripts/eth0.cfg ubuntu@${ip}:eth0.cfg
